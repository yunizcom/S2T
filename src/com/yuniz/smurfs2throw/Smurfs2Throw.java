package com.yuniz.smurfs2throw;
...
import com.yuniz.smurfs2throw.R;
...
public class Smurfs2Throw extends Activity implements OnGestureListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_smurfs2_throw);
		...
		try 
		{
		    ...
		    ims1 = getAssets().open("minion_8.png");
		    d1 = Drawable.createFromStream(ims1, null);
...
public void initTitans(ImageView titanSelect, int locations){
	...
	public void reFreshMinions(){
		String minionGIF = "minion_" + generateNumber(1,15) + ".png";
	...
	public void gameScoreSubmitAPI(String nickname, int scores){
		...
		String url = "http://www.yuniz.com/apps/s2t/?mod=1&nickname=" + nickname + "&score=" + scores;
		//-------load JSON
	...
	public void gameScoresAPI(String pages){
		String url = "http://www.yuniz.com/apps/s2t/?mod=2&page=" + pages;
		//-------load JSON
		List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
        //nameValuePairs.add(new BasicNameValuePair("convo_id", "4546db1fd1"));
        //nameValuePairs.add(new BasicNameValuePair("say", words));
	...
	public void gameOver(){
		...
		resultTxt.setText(totalHits + " cars threw!");
